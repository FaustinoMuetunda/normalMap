...
void SceneReflectCube::compileAndLinkShader()
{
	try {
#ifdef __APPLE__
    prog.compileShader("C:/Users/faust/source/repos/cap4/cap4/recursos/shader/cubemap_reflect_41.vs");
		prog.compileShader("C:/Users/faust/source/repos/cap4/cap4/recursos/shader/cubemap_reflect_41.fs");
#else
		prog.compileShader("C:/Users/faust/source/repos/cap4/cap4/recursos/shader/cubemap_reflect.vs");
		prog.compileShader("C:/Users/faust/source/repos/cap4/cap4/recursos/shader/cubemap_reflect.fs");
#endif
    	prog.link();
    	prog.use();

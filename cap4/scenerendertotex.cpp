...
{
  try {
    prog.compileShader("C:/Users/faust/source/repos/cap4/cap4/recursos/shader/rendertotex.vs");
    prog.compileShader("C:/Users/faust/source/repos/cap4/cap4/recursos/shader/rendertotex.fs");
    prog.link();
    prog.use();

...
void SceneProjTex::initScene()
{
    ...
    Texture::loadTexture("C:/Users/faust/source/repos/cap4/cap4/recursos/media/texture/textureflower.png");
...
void SceneProjTex::compileAndLinkShader()
{
  try {
#ifdef __APPLE__
    prog.compileShader("C:/Users/faust/source/repos/cap4/cap4/recursos/shader/projtex_41.vs");
    prog.compileShader("C:/Users/faust/source/repos/cap4/cap4/recursos/shader/projtex_41.fs");
#else
    prog.compileShader("C:/Users/faust/source/repos/cap4/cap4/recursos/shader/projtex.vs");
    prog.compileShader("C:/Users/faust/source/repos/cap4/cap4/recursos/shader/projtex.fs");
#endif
    prog.link();
    prog.use();

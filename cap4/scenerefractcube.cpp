...
void SceneRefractCube::initScene()
{
    ...
    loadCubeMap("C:/Users/faust/source/repos/cap4/cap4/recursos/media/texture/cubemap_night/night");
}
...
void SceneRefractCube::compileAndLinkShader()
{
  try {
#ifdef __APPLE__
    prog.compileShader("C:/Users/faust/source/repos/cap4/cap4/recursos/shader/cubemap_refract_41.vs");
    prog.compileShader("C:/Users/faust/source/repos/cap4/cap4/recursos/shader/cubemap_refract_41.fs");
#else
    prog.compileShader("C:/Users/faust/source/repos/cap4/cap4/recursos/shader/cubemap_refract.vs");
    prog.compileShader("C:/Users/faust/source/repos/cap4/cap4/recursos/shader/cubemap_refract.fs");
#endif
    prog.link();
    prog.use();
